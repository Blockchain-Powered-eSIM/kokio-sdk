...
export const optimismSepoliaFactoryAddresses: Record<string, Address> = {
    DEVICE_WALLET_FACTORY: '0x48312180efF845F005CBA0ef1834a7F001F65d27',
    ESIM_WALLET_FACTORY: '0x1947F48d4c032Ee560966C940efac3FE15a7F398',
    LAZY_WALLET_REGISTRY: '0x45e8a612fb5e7cD395A4A5758e82b1730230f913',
    REGISTRY: '0x78EFB76bF434F1594aB021Dd1b1287Ed988e68bC',
    ENTRY_POINT: '0x0000000071727De22E5E9d8BAf0edAc6f37da032',
    SENDER_CREATOR: '0xefc2c1444ebcc4db75e7613d20c6a62ff67a167c',
    P256VERIFIER: '0x8a1E53b903efcc6b252CE4bD3b255202318505Ef'
}

export const optimismSepoliaFactoryAddressesV1: Record<string, Address> = {
